...
int main(int argc, char* argv[]){
    ...
    for (int i=0;i<n-1;++i){
        ...
        get<2>(edges[i]) = rnd.next((int)1e9 - 1000, (int)1e9);
    }
    edges = edges.shuffle();
    ...
    while (q--){
        ...
        if (op == 1){
            ...
            if (rnd.next(2)) cout << ' ' << rnd.next(0ll, cur_dep * 11 / 10);
            else cout << ' ' << (long long)1e18;
        }
        else if (op == 4){}
        else if (op == 5){
            if (rnd.next(2)) cout << ' ' << rnd.next(0ll, cur_dep * 2);
            else cout << ' ' << (long long)1e18;
        }
        else if (op == 6){
