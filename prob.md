...
6. Report the index and current value of the treasure stored at dungeon $d_i$. It is guaranteed that $d_i$ is an advanced dungeon located in the direct route from current dungeon to dungeon $0$.
